...
public class StatMonitorHuman : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (oldState == HumanState.Climb && (state == HumanState.Jump || state == HumanState.Idle || state == HumanState.Walk) && Game.instance != null && Game.instance.state == GameState.PlayingLevel)
		{
