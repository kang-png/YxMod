...
public class SignalHitRotLimit : Node
{
	...
	private void CalcEulerSetting()
	{
		if (xRotation)
		{
			currentRotation = base.transform.localRotation.eulerAngles.x;
		}
		if (yRotation)
		{
			currentRotation = base.transform.localRotation.eulerAngles.y;
		}
		if (zRotation)
		{
			currentRotation = base.transform.localRotation.eulerAngles.z;
		}
