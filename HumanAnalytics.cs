...
public class HumanAnalytics : MonoBehaviour
{
	...
	{
		Analytics.CustomEvent("multiplayer", new Dictionary<string, object> { { "isServer", host } });
	}

	public void LogVersion(string version)
	{
		Analytics.CustomEvent("version", new Dictionary<string, object> { { "version", version } });
	}
}
