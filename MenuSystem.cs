...
public class MenuSystem : MonoBehaviour
{
	...
	public void ShowPauseMenu()
	{
		...
		MenuTransition to = ((Game.instance.currentLevelType != 0) ? GetMenu<PauseMenu>() : ((Game.instance.currentLevelNumber != Game.instance.levelCount) ? ((MenuTransition)GetMenu<PauseMenu>()) : ((MenuTransition)GetMenu<CreditsMenu>())));
		if (!NetGame.isLocal)
		{
