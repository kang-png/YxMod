...
public class RagdollTexture : MonoBehaviour
{
	...
	public void PaintStep(Camera camera, Material unprojectMaterial, int mask)
	{
		...
		ref RenderBuffer reference = ref buffers[0];
		reference = this.renderTexture.colorBuffer;
		ref RenderBuffer reference2 = ref buffers[1];
		reference2 = paintTarget.colorBuffer;
