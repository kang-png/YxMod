...
public class SnowBallGrowth : Node, IPostEndReset, IPreReset
{
	...
	private void FixedUpdate()
	{
		...
		lastRot = rotation;
		float num = 0f;
		if ((InsideIceCaves.instance == null || !InsideIceCaves.instance.SnowballInsideCave(this)) && Physics.Raycast(base.transform.position, Vector3.down, out var hitInfo, base.transform.lossyScale.x / 2f + 0.2f, 1))
		{
