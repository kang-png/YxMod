...
public class SignalSetTranslationForObject : Node
{
	...
	protected override void OnEnable()
	{
		...
		base.OnEnable();
		body = objectToMove.GetComponent<Rigidbody>();
	...
	private void SignalChanged(float val)
	{
		...
		{
			objectToMove.transform.localPosition = initialPosition + vector;
		}
		else
		{
			objectToMove.transform.position = initialPosition + vector;
		}
	}
}
