...
public class LegMuscles
{
	...
	private void JumpAnimation(Vector3 torsoFeedback)
	{
		...
		if (human.jump)
		{
			...
			float f = Mathf.Clamp(human.groundManager.groudSpeed.y, 0f, 100f);
			f = Mathf.Pow(f, 1.2f);
		...
		else
		{
			...
			float num12 = Mathf.Clamp(num11 / Time.fixedDeltaTime, 0f, num8);
			ragdoll.partChest.rigidbody.SafeAddForce(num12 * human.controls.walkDirection.normalized);
		}
	}
	...
	private void ApplyJumpImpulses()
	{
		...
		Vector3 vector = Vector3.up * upImpulse * num;
		Vector3 vector2 = human.controls.walkDirection.normalized * forwardImpulse * num;
		ragdoll.partHead.rigidbody.SafeAddForce(vector * 0.1f + vector2 * 0.1f, ForceMode.Impulse);
		ragdoll.partChest.rigidbody.SafeAddForce(vector * 0.1f + vector2 * 0.1f, ForceMode.Impulse);
		ragdoll.partWaist.rigidbody.SafeAddForce(vector * 0.1f + vector2 * 0.1f, ForceMode.Impulse);
		ragdoll.partHips.rigidbody.SafeAddForce(vector * 0.1f + vector2 * 0.1f, ForceMode.Impulse);
		ragdoll.partBall.rigidbody.SafeAddForce(vector * 0.1f + vector2 * 0.1f, ForceMode.Impulse);
		ragdoll.partLeftThigh.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partRightThigh.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partLeftLeg.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partRightLeg.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partLeftFoot.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partRightFoot.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partLeftArm.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partRightArm.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partLeftForearm.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		ragdoll.partRightForearm.rigidbody.SafeAddForce(vector * 0.05f + vector2 * 0.05f, ForceMode.Impulse);
		human.groundManager.DistributeForce(-vector / Time.fixedDeltaTime, ragdoll.partBall.rigidbody.position);
	}
