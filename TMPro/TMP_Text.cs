...
public class TMP_Text : MaskableGraphic
{
	...
	protected virtual void DrawTextHighlight(Vector3 start, Vector3 end, ref int index, Color32 highlightColor)
	{
		...
		ref Vector3 reference = ref vertices[index + 1];
		reference = new Vector3(start.x, end.y, 0f);
		vertices[index + 2] = end;
		ref Vector3 reference2 = ref vertices[index + 3];
		reference2 = new Vector3(end.x, start.y, 0f);
		Vector2[] uvs = m_textInfo.meshInfo[0].uvs0;
