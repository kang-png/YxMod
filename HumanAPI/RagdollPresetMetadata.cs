...
public class RagdollPresetMetadata : WorkshopItemMetadata
{
	...
	public Color GetColor(WorkshopItemType part, int channel)
	{
		...
		{
			1 => HexConverter.HexToColor(part2.color1, default(Color)), 
			2 => HexConverter.HexToColor(part2.color2, default(Color)), 
			3 => HexConverter.HexToColor(part2.color3, default(Color)), 
			_ => default(Color), 
		};
	}
